// This file has been copied and adapted from https://github.com/shopware/platform/blob/trunk/tests/e2e/cypress.config.js
...
module.exports = defineConfig({
  ...
  e2e: {
    ...
    baseUrl: process.env.APP_URL ?? 'https://127.0.0.1:8005',
  },
})
